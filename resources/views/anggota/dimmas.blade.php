...
<ul class="nav nav-tabs" role="tablist">
    <li class="nav-item">
        <a class="nav-link" href="#approve" role="tab" data-toggle="tab">Daftar Pekerjaan</a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" href="#belumapprove" role="tab" data-toggle="tab">Pekerjaan Belum Dikerjakan</a>
    </li>
</ul>
